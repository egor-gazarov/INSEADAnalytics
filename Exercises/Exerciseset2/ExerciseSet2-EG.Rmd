...
1. To explain at least 50% of variance I need 6 factors.

2. The highest five weights in the first component are `r head(sort(Rotated_Factors$'Component 1', decreasing = TRUE),5)`.

3. First 10 components can be interpreted as:
* Component 1 - Safest government bonds and notes
* Component 2 - European papers and metals
* Component 3 - European bonds
* Component 4 - Largest stock exchanges
* Component 5 - European portfolio
* Component 6 - Oil and its products
* Component 7 - Non-energy commodities
* Component 8 - Cereals
* Component 9 - Precious metals
* Component 10 - Asian stocks
...
**Your Answers here:**
<br>
1. Code takes many moving averages signals, let them vote with their signes, and allocated investment based on this.
<br>
2. Change in this comand line changes the approach for portfolio composition, e.g. what are the range and step for calculating moving average.
<br>
